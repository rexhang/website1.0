 ...
 * npm install gulp gulp-minify-css gulp-inject gulp-htmlmin gulp-imagemin gulp-notify gulp-uglify gulp-connect gulp-concat gulp-rename color del --save-dev
 */
...
var gulp = require('gulp'),
     ...
     * [description] 压缩图片
     * @author
     * @dateTime 2016-11-04T09:47:12+0800
     * @param    {[type]}                 ) {                   return gulp.src('./img                        ;    } [description]
     * @return   {[type]}                   [description]
     */
    ...
    gulp.task('default', ['clean'], function() {
        console.log('dist目录中的img、css和js文件夹以及*.html文件清空完毕！'.red);
